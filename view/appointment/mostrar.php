...
<body>
    ...
    <a href="../view/appointment/reporte.php?export=pdf" class="btn btn-info btn-border btn-round btn-sm mr-2">
        <span class="btn-label">
            <i class="fa fa-file-pdf"></i>
        </span>
        Export PDF
    </a>
											<a href="../view/appointment/reporte.php?export=excel" class="btn btn-success btn-border btn-round btn-sm">
        <span class="btn-label">
